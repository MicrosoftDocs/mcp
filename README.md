...
> **Note for Roo Code users:** Use `"type": "streamable-http"` instead of `"type": "http"` in your configuration.
...
| **Roo Code** | Manual configuration required | [Roo Code MCP Guide](https://docs.roocode.com/features/mcp/using-mcp-in-roo) |
